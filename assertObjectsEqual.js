...
assertObjectsEqual({ name: "Olaseni" }, { name: "Olaseni" }); // PASS
assertObjectsEqual({ name: "Olaseni", lastName: "Cole" }, { name: "Olaseni" }); // FAIL
assertObjectsEqual({ name: "Olaseni", lastName: "Cole" }, { lastName: "Cole", name: "Olaseni" }); // PASS
assertObjectsEqual({ name: { first: "Olaseni", last: "Cole" }}, {name: { first: "Olaseni", last: "Cole" }}); // PASS